...
3. Configure the `leagueId` web-part property; the scaffold loads `admin-service.js` through `createSharePointGameStore(createSpfxListClient(...), leagueId)` and renders loading/error states.
