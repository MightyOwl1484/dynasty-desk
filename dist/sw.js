const CACHE = 'dynasty-desk-v18';
const ASSETS = [
  './', './index.html', './styles.css', './app.js', './commissioner.html', './commissioner.js', './admin.css',
  './domain/models.js', './domain/academy.js', './domain/form.js', './domain/scouting.js', './domain/objectives.js', './domain/simulation.js', './domain/permissions.js', './domain/audit.js', './domain/offseason.js', './domain/training.js',
