...
if (!entry.includes('BaseClientSideWebPart') || !entry.includes('ReactDom.render') || !entry.includes('this.context.spHttpClient') || !entry.includes('loadAdminContext') || !entry.includes('persistLockPlan')) throw new Error('SPFx entrypoint is missing the SharePoint data-service boundary.');
