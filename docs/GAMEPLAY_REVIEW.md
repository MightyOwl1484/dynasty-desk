...
The campaign stakes are visible before the first bout: finish in the top half. The same objective rule reports current table position each week and produces the final verdict, avoiding a hidden or retroactive success condition.
